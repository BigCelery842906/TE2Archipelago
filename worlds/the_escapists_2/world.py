...
class TheEscapists2World(World):
    ...
    def fill_slot_data(self) -> Mapping[str, Any]:
        ...
        # TODO: Once options are in, do slot data filling
        return self.options.as_dict("center_perks", "cougar_creek", "rattlesnake_springs", "kapow_camp", "hms_orca", "hmp_offshore", "fort_tundra", "area_17", "air_force_con", "uss_anomaly", "strength_step", "stamina_step", "intellect_step", "trap_chance", "unique_escapes_required")